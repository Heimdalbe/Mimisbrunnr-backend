...
public static class Mappers
{
    ...
    #region Event
    public static EventDto.Simple EventToSimpleDto(Event e)
    {
    ...
    public static EventDto.Detailed EventToDetailedDto(Event e)
    {
    ...
    public static SponsorDto.Simple SponsorToSimpleDto(Sponsor sponsor)
    {
    ...
    public static SponsorDto.Detailed SponsorToDetailedDto(Sponsor sponsor)
    {
